...
public class Project {
        public static void main(String[] args) throws SQLException {
                ...
                String challengeTable = "CREATE TABLE Challenge( item_id VARCHAR(16) NOT NULL, difficulty INT, problem_statement VARCHAR(5096) NOT NULL, PRIMARY KEY(item_id), FOREIGN KEY(item_id) REFERENCES Item(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB";

                String contestTable = "CREATE TABLE Contest( item_id VARCHAR(16) NOT NULL, description VARCHAR(5096) NOT NULL, date DATE NOT NULL, name VARCHAR(128) NOT NULL, duration INT NOT NULL, PRIMARY KEY(item_id), FOREIGN KEY(item_id) REFERENCES Item(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB";
                ...
                String has_categoryTable = "CREATE TABLE has_category(challenge_id VARCHAR(16) NOT NULL, category_name VARCHAR(64) NOT NULL, PRIMARY KEY(challenge_id, category_name), FOREIGN KEY(challenge_id) REFERENCES Challenge(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(category_name) REFERENCES Category(category_name) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String savedTable = "CREATE TABLE saves( username VARCHAR(32) NOT NULL, announcement_id VARCHAR(12) NOT NULL, PRIMARY KEY(username, announcement_id), FOREIGN KEY(username) REFERENCES User(username) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(announcement_id) REFERENCES Announcement(announcement_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
                ...
                String verifyTable = "CREATE TABLE verify(editor_id VARCHAR(4) NOT NULL, company_id VARCHAR(8) NOT NULL, PRIMARY KEY(company_id), FOREIGN KEY(editor_id) REFERENCES Editor(editor_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(company_id) REFERENCES Company(company_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String announceTable = "CREATE TABLE announce( company_id VARCHAR(8) NOT NULL, announcement_id VARCHAR(12) NOT NULL, PRIMARY KEY(announcement_id), FOREIGN KEY(company_id) REFERENCES Company(company_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(announcement_id) REFERENCES Announcement(announcement_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
                ...
                String hasChallengeTable = "CREATE TABLE has_challenge(contest_id VARCHAR(16) NOT NULL, challenge_id VARCHAR(16) NOT NULL, question_number INT, PRIMARY KEY(contest_id, challenge_id), FOREIGN KEY(contest_id) REFERENCES Contest(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(challenge_id) REFERENCES Challenge(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String sponsorTable = "CREATE TABLE sponsor( company_id VARCHAR(8) NOT NULL, contest_id VARCHAR(16), PRIMARY KEY(company_id, contest_id), FOREIGN KEY(company_id) REFERENCES Company(company_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(contest_id) REFERENCES Contest(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String createTable = "CREATE TABLE create_table(editor_id VARCHAR(4) NOT NULL, item_id VARCHAR(16) NOT NULL, date DATE, PRIMARY KEY(item_id), FOREIGN KEY(editor_id) REFERENCES Editor(editor_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(item_id) REFERENCES Item(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
                ...
                String testTable = "CREATE TABLE test( coding_id VARCHAR(16) NOT NULL, test_id VARCHAR(16) NOT NULL, PRIMARY KEY(test_id), FOREIGN KEY(coding_id) REFERENCES Coding(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(test_id) REFERENCES TestCase(test_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
                ...
                String submitsTable = "CREATE TABLE submits( username VARCHAR(32) NOT NULL, submission_id VARCHAR(32) NOT NULL, PRIMARY KEY(submission_id), FOREIGN KEY(username) REFERENCES User(username) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(submission_id) REFERENCES Submission(submission_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String hasSubmissionTable = "CREATE TABLE has_submission( challenge_id VARCHAR(16) NOT NULL, submission_id VARCHAR(32) NOT NULL, PRIMARY KEY(submission_id), FOREIGN KEY(challenge_id) REFERENCES Challenge(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(submission_id) REFERENCES Submission(submission_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String enrollTable = "CREATE TABLE enroll( username VARCHAR(32) NOT NULL, contest_id VARCHAR(16) NOT NULL, PRIMARY KEY(username, contest_id), FOREIGN KEY(contest_id) REFERENCES Contest(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(username) REFERENCES User(username) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
                ...
                String sendsTable = "CREATE TABLE sends( company_id VARCHAR(20) NOT NULL, invite_id VARCHAR(16) NOT NULL, PRIMARY KEY(invite_id), FOREIGN KEY(company_id) REFERENCES Company(company_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(invite_id) REFERENCES Invite(invite_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String includesTable = "CREATE TABLE includes( invite_id VARCHAR(16) NOT NULL, interview_id VARCHAR(16) NOT NULL, PRIMARY KEY(invite_id), FOREIGN KEY(interview_id) REFERENCES Interview(item_id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(invite_id) REFERENCES Invite(invite_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String isInvitedTable = "CREATE TABLE is_invited( username VARCHAR(32) NOT NULL, invite_id VARCHAR(16) NOT NULL, PRIMARY KEY(username, invite_id), FOREIGN KEY(username) REFERENCES User(username) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(invite_id) REFERENCES Invite(invite_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";

                String interviewTable = "CREATE TABLE Interview(item_id VARCHAR(16) NOT NULL, title VARCHAR(128), description VARCHAR(1024), earliest_date DATE, latest_date DATE NOT NULL, result INT, duration INT, PRIMARY KEY(item_id), FOREIGN KEY(item_id) REFERENCES Contest(item_id) ON UPDATE CASCADE ON DELETE CASCADE) ENGINE=INNODB;";
