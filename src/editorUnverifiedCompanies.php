    ...
    <div class="user-all-announcements-content">
      <div class="user-all-announcements-content-bottom">
        ...
        <div class="new-verify-company-footer">
          <a href="#" class="btn btn-outline-secondary btn-lg user-all-announcements-content-bottom-links" >COMPANY ID - COMPANY NAME</a>
          <a href="#" class="btn btn-primary" style="height: 48px;">Verify</a>
        </div>
        <div class="new-verify-company-footer">
          <a href="#" class="btn btn-outline-secondary btn-lg user-all-announcements-content-bottom-links" >COMPANY ID - COMPANY NAME</a>
          <a href="#" class="btn btn-primary" style="height: 48px;">Verify</a>
