  ...
  <div class="user-old-submission">
    ...
    <div class="user-all-announcements-content">
      <div class="user-all-announcements-content-top">
        <button class="btn btn-primary ">Filter Companies</button>
      </div>
      <div class="user-all-announcements-content-bottom">
        <!-- EXAMPLE -->
        <div class="user-all-announcements-content-bottom-links-box">
          <a href="#" class="btn btn-outline-secondary btn-lg user-all-announcements-content-bottom-links">DATE-SUBMISSION RESULT</a>
          <button href="#" class="btn btn-outline-danger user-all-announcements-content-bottom-links-save" onclick="save(1, 'key1')" id="key1">
            <?php
            $saved = 1;
            if (!$saved) {
        ...
        <div class="user-all-announcements-content-bottom-links-box">
          <a href="#" class="btn btn-outline-secondary btn-lg user-all-announcements-content-bottom-links">DATE-SUBMISSION RESULT</a>
          <button href="#" class="btn btn-outline-danger user-all-announcements-content-bottom-links-save" onclick="save(0, 'key1')" id="key1">
            <?php
            $saved = 0;
            if (!$saved) {
              echo "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" fill=\"currentColor\" class=\"bi bi-bookmarks\" viewBox=\"0 0 16 16\">
