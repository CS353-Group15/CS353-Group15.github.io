  ...
  <div class="new-invite-content">
    ...
    <div class="new-invite-content-body">
      ...
      <div class="form-floating new-invite-content-title" style="width: 25%; padding: 3px">
        ...
        <label for="floatingTextarea">Earliest date</label>
      </div>
      <div class="form-floating new-invite-content-title" style="width: 25%; padding: 3px">
        <input class="form-control" placeholder="Latest date" id="floatingTextarea" style="resize:none" type="date"></textarea>
        <label for="floatingTextarea">Latest date</label>
      </div>
    </div>
    <div class="new-invite-content-body">
      <div class="form-floating new-invite-content-title" style="width: 100%; padding: 3px;">
        <textarea class="form-control" placeholder="User" id="floatingTextarea" style="resize:none"></textarea>
    ...
    <div class="new-invite-content-body">
      <div class="form-floating new-invite-content-title" style="width: 100%; padding: 3px; min-height: 124px">
        <textarea class="form-control" placeholder="Message" id="floatingTextarea" style="resize:none; height: 100%"></textarea>
